...
// $ npx hardhat run scripts/phase4/polygon.js
...
async function main() {
  ...
  const sourceChainId = hardhat.config.defaultNetwork === 'polygon'? 137: 80001
  const destinationChainId = hardhat.config.defaultNetwork === 'polygon'? 1: 4
  ...
  console.log('')
  console.log(' 4. In GratisBridge, add Polygon destination')
  console.log(`    - ${network.scanner}/address/${bridge.address}#writeContract`)
  console.log(`    - addDestination( ${sourceChainId}, ${bridge.address} )`)
  console.log('')
  console.log(' 5. In GratisBridge, add Ethereum destination')
  console.log(`    - ${network.scanner}/address/${bridge.address}#writeContract`)
